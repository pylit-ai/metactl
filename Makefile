...
sync-packaged-starter-mirror:
	$(PYTHON) scripts/sync_packaged_starter_mirror.py
...
verify-v1-release-gate: verify-architecture-metrics verify-release-consumers $(VALIDATE_STAMP)
