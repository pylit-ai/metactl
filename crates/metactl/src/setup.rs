        ...
        return Ok(CommandOutput {
            ...
            json: success_json(
                ...
                json!({
                    ...
                    "targets": targets,
                    "profile_resolution": profile_resolution_for_config(cli, existing_config.as_ref()),
            ...
            return Ok(CommandOutput {
                ...
                json: success_json(
                    ...
                    json!({
                        ...
                        "profile_resolution": profile_resolution_for_config(cli, Some(&existing)),
                        "artifact_policy": artifact_policy.as_str(),
    ...
    Ok(CommandOutput {
        ...
        json: success_json(
            ...
            json!({
                ...
                "config_path": config_path,
                "targets": targets,
                "profile_resolution": init_output.json["profile_resolution"].clone(),
                "ran_sync": false,
