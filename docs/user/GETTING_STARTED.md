...
```bash
cargo install metactl --version 0.1.20 --locked
# Installed package `metactl v0.1.20` (executable `metactl`)
```
...
```bash
cargo install metactld --version 0.1.20 --locked
# Installed package `metactld v0.1.20` (executable `metactld`)
```
...
metactl --version
metactld --version
# metactl 0.1.20 (metactl/v2alpha1)
# metactld 0.1.20
```
...
#    Compiling metactl v0.1.20 (...)
#    Compiling metactld v0.1.20 (...)
