...
# Installed package `metactl v0.1.8` (executable `metactl`)
```
...
# Installed package `metactld v0.1.8` (executable `metactld`)
```
...
#    Compiling metactl v0.1.8 (...)
#    Compiling metactld v0.1.8 (...)
