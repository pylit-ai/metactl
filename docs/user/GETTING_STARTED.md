...
# Installed package `metactl v0.1.21` (executable `metactl`)
```
...
# Installed package `metactld v0.1.21` (executable `metactld`)
```
...
#    Compiling metactl v0.1.21 (...)
#    Compiling metactld v0.1.21 (...)
