...
# Installed package `metactl v0.1.9` (executable `metactl`)
```
...
# Installed package `metactld v0.1.9` (executable `metactld`)
```
...
#    Compiling metactl v0.1.9 (...)
#    Compiling metactld v0.1.9 (...)
