...
# Installed package `metactl v0.1.7` (executable `metactl`)
```
...
# Installed package `metactld v0.1.7` (executable `metactld`)
```
...
#    Compiling metactl v0.1.7 (...)
#    Compiling metactld v0.1.7 (...)
