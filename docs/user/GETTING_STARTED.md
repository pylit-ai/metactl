...
# Installed package `metactl v0.1.19` (executable `metactl`)
```
...
# Installed package `metactld v0.1.19` (executable `metactld`)
```
...
#    Compiling metactl v0.1.19 (...)
#    Compiling metactld v0.1.19 (...)
