...
# Installed package `metactl v0.1.12` (executable `metactl`)
```
...
# Installed package `metactld v0.1.12` (executable `metactld`)
```
...
#    Compiling metactl v0.1.12 (...)
#    Compiling metactld v0.1.12 (...)
